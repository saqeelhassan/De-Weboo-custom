                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="top-rated-pragraph">
                            ...
                            <form method="post" action="<?php echo e(dw_self_path()); ?>" class="form-style1 form-style2 d-flex align-items-center justify-content-between">
                                ...
                                <input type="email" name="newsletter_email" autocomplete="email" placeholder="Your email address" required value="<?php echo e($newsletter_email ?? ''); ?>">
                                <button type="submit" class="arrow" aria-label="Subscribe"><i class="fas fa-chevron-right"></i></button>
                            </form>
                        </div>
                    </div>
