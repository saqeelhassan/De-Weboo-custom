...
$call_rep_image = $call_rep_image ?? ($call_show_rep ? $rep['image'] : '');
...
<div class="<?php echo e($call_wrapper_class); ?>">
    ...
    <?php endif; ?>
    <a href="<?php echo e($whatsapp_url); ?>" target="_blank" rel="noopener noreferrer" class="icon p3-bg d-center rounded-circle flex-shrink-0 contact-whatsapp-icon" aria-label="WhatsApp us at <?php echo e($tel_display); ?>">
