...
function dw_portfolio_projects(): array
{
    return [
        'sindh-wdd-dashboard' => [
            ...
            'liveUrl' => 'https://wdddashboard.gos.pk/admin/login',
        ...
        'dream-asa-homes' => [
            ...
            'liveUrl' => 'https://dreamasahomes.com/',
        ...
        'new-super-prime' => [
            ...
            'liveUrl' => 'https://newsuperprime.sa/',
