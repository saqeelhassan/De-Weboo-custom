...
function dw_portfolio_projects(): array
{
    return [
        ...
        'edustream-lms' => [
            ...
            'overview' => 'A high-performance, white-label Learning Management System (LMS) built completely from scratch. Designed with user experience in mind, this platform features three completely distinct portal environments tailored to the workflows of Administrators, Instructors, and Students.',
            'keyFeatures' => [
                'Multi-Level Roles: Specialized dashboards ensuring seamless workflows for admins, teachers, and learners.',
                'Course & Content Management: Intuitive module builders allowing instructors to upload media, assignments, and curriculum updates dynamically.',
                'Real-time Performance Tracking: Detailed progress tracking for students alongside robust gradebook management for teachers.',
            ],
            'technicalHighlights' => [
        ...
        'dream-asa-homes' => [
            ...
            'overview' => 'A bespoke, lightning-fast real estate platform built entirely from scratch on top of WordPress. Moving completely away from heavy page-builders, this custom theme allows users to quickly filter, browse, and view high-resolution property listings through a deeply responsive interface.',
            'keyFeatures' => [
                'Custom Property Fields: Tailored back-end panel structure empowering agents to cleanly input dimensions, pricing, and structural details.',
                'Advanced Layout Filtering: Clean UI grids allowing prospective buyers to quickly refine property searches.',
                'Optimized Mobile UX: Tailor-made, lightweight layout tailored for seamless mobile browsing.',
            ],
            'technicalHighlights' => [
        ...
        'ezfalcons-seo' => [
            ...
            'images' => [
                'cover' => 'assets/img/portfolio/ezfalcons-seo/cover.jpg',
                'card' => 'assets/img/portfolio/ezfalcons-seo/card.jpg',
                'gallery1' => 'assets/img/portfolio/ezfalcons-seo/gallery-1.jpg',
                'gallery2' => 'assets/img/portfolio/ezfalcons-seo/gallery-2.jpg',
            ],
        ],
        'ezfalcons-digital-marketing' => [
            ...
            'images' => [
                'cover' => 'assets/img/portfolio/ezfalcons-digital-marketing/cover.jpg',
                'card' => 'assets/img/portfolio/ezfalcons-digital-marketing/card.jpg',
                'gallery1' => 'assets/img/portfolio/ezfalcons-digital-marketing/gallery-1.jpg',
                'gallery2' => 'assets/img/portfolio/ezfalcons-digital-marketing/gallery-2.jpg',
            ],
        ],
        'dr-yousef-pour-site' => [
            ...
            'services' => 'Custom WordPress Theme Development, Multilingual Architecture, Appointment UI Design',
            'techStack' => 'WordPress, PHP, JavaScript, Tailwind CSS / Custom CSS',
            'category' => 'Healthcare',
            'projectDate' => 'Production deployment',
            'overview' => 'A premium, bespoke portfolio and professional platform developed from the ground up for Dr. Yousef Pour. Built completely custom without bloated page builders, the website is engineered to project clinical authority, showcase medical/academic publications, and provide a frictionless booking experience for patients and clients.',
            'keyFeatures' => [
                'Multilingual Capabilities: Clean implementation for seamless language switching, accommodating a diverse global patient or student base.',
                'Academic & Publication Directory: A beautifully structured archive enabling users to search, filter, and read published medical research or articles.',
            ...
            'technicalHighlights' => [
                'Wrote clean, semantic PHP templates from scratch, significantly reducing page load times compared to off-the-shelf medical themes.',
                'Developed custom meta fields, allowing the client to easily upload, categorize, and manage complex publication details without breaking the layout.',
        ...
        'new-super-prime-seo' => [
            ...
            'images' => [
                'cover' => 'assets/img/portfolio/new-super-prime-seo/cover.jpg',
                'card' => 'assets/img/portfolio/new-super-prime-seo/card.jpg',
                'gallery1' => 'assets/img/portfolio/new-super-prime-seo/gallery-1.jpg',
                'gallery2' => 'assets/img/portfolio/new-super-prime-seo/gallery-2.jpg',
            ],
        ],
        'new-super-prime-digital-marketing' => [
            ...
            'images' => [
                'cover' => 'assets/img/portfolio/new-super-prime-digital-marketing/cover.jpg',
                'card' => 'assets/img/portfolio/new-super-prime-digital-marketing/card.jpg',
                'gallery1' => 'assets/img/portfolio/new-super-prime-digital-marketing/gallery-1.jpg',
                'gallery2' => 'assets/img/portfolio/new-super-prime-digital-marketing/gallery-2.jpg',
            ],
        ],
    ];
}
