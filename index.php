...
$featuredPortfolioSlots = [
    ['image' => 'assets/img/services/select1.png', 'category' => 'DESIGN', 'title' => 'Technology solution', 'url' => 'portfolio'],
    ['image' => 'assets/img/services/select2.png', 'category' => 'TECHNOLOGY', 'title' => 'Platform integration', 'url' => 'portfolio'],
    ['image' => 'assets/img/services/select3.png', 'category' => 'TECHNOLOGY', 'title' => 'Web development', 'url' => 'portfolio'],
    ['image' => 'assets/img/services/select4.png', 'category' => 'IDEAS', 'title' => 'Smart vision', 'url' => 'portfolio'],
];
                    ...
                    <div class="container">
                        <div class="banner-content text-center">
                            <span class="hero-badge3 mb-xxl-4 mb-3 d-block white fw_600 text-uppercase hero-badge-lg">
                                Software Engineering · Enterprise Ready
                            </span>
                ...
                <div class="vission-left">
                    ...
                    <ul class="d-grid gap-2 mb-xl-5 mb-4">
                        <li class="fs-seven fw_600 white d-flex align-items-center gap-2 wow fadeInUp"
                            data-wow-delay=".3s">
                            <i class="fa-solid fa-circle-check p3-clr"></i> Web Development: full-stack, front-end, and back-end development services
                        </li>
                        <li class="fs-seven fw_600 white d-flex align-items-center gap-2 wow fadeInUp"
                            data-wow-delay=".35s">
                            <i class="fa-solid fa-circle-check p3-clr"></i> Mobile App Development: native and cross-platform apps for iOS and Android
                        </li>
                        <li class="fs-seven fw_600 white d-flex align-items-center gap-2 wow fadeInUp"
                            data-wow-delay=".38s">
                            <i class="fa-solid fa-circle-check p3-clr"></i> AI and Machine Learning: advanced AI solutions to enhance business efficiency
                        </li>
                        <li class="fs-seven fw_600 white d-flex align-items-center gap-2 wow fadeInUp"
                            data-wow-delay=".4s">
                            <i class="fa-solid fa-circle-check p3-clr"></i> Digital Marketing, SEO &amp; Cloud Services
                        </li>
                    </ul>
                ...
                <div class="vission-right d-flex gap-sm-4 gap-2">
                    ...
                    <div class="cont">
                        ...
                        <p class="white65 fs-seven mb-xxl-5 mb-4 wow fadeInUp" data-wow-delay=".3s">
                            We engineer platforms first, then scale them—Development &amp; AI Engineering first, Growth &amp; Infrastructure second.
                        </p>
        ...
        <div class="container">
            <div
                ...
                <div class="section-title">
                    ...
                    <h2 class="wow fadeInUp black fw-bold visible-slowly-right" data-wow-delay=".3s">
                        Enterprise IT solutions. Contract-ready delivery.
                    </h2>
                </div>
            </div>
                ...
                <div class="col-lg-7">
                    <div class="section-title text-center">
                        ...
                        <p class="pra fs-six fw-semibold wow fadeInUp visible-slowly-right mb-0" data-wow-delay=".3s">
                            Software Developers · Growth &amp; Infrastructure
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-6 justify-content-between">
                <div class="col-xxl-6 col-lg-6">
                    <div class="row g-2">
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="industry-icon d-center rounded-3 d-grid justify-content-center">
                                <img loading="lazy" src="/assets/img/icon/indus-realestate.png" alt="Illustration" class="mb-3 d-block m-auto">
                                <span class="fs-six fw_500 white75 d-block">
                                    Real Estate
                                </span>
                            </div>
...
<?php
$dw_home_team_slugs = ['development', 'devops-cloud', 'hr'];
$dw_home_team_all = dw_team_members();
foreach ($dw_home_team_slugs as $dw_home_team_delay_index => $dw_home_team_slug) :
    $dw_team = $dw_home_team_all[$dw_home_team_slug];
?>
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="team-items wow fadeInUp" data-wow-delay=".4s">
                        ...
                        <div class="content">
                            <h4 class="black mb-1"><a href="<?php echo e(dw_team_member_url($dw_home_team_slug)); ?>" class="black"><?php echo e($dw_team['name']); ?></a></h4>
                            <span class="fs-seven fw-medium d-block"><?php echo e($dw_team['role']); ?></span>
                            <?php $team_view_href = dw_team_member_url($dw_home_team_slug); require __DIR__ . '/includes/team-view-button.php'; ?>
                        </div>
                    </div>
                </div>
<?php endforeach; unset($dw_home_team_slugs, $dw_home_team_all, $dw_home_team_slug, $dw_home_team_delay_index, $dw_team); ?>
            </div>
        </div>
    </section>
            ...
            <div class="row g-0 align-items-xl-end justify-content-center">
                <div class="col-lg-6 order-lg-0 order-1">
                    <div class="contact-thumb1 w-100 position-relative">
                        <img loading="lazy" src="/assets/img/services/solutio-web.jpg" alt="Enterprise IT team reviewing contract-ready delivery capabilities" class="w-100">
                    ...
                    <div class="wirefram-content">
                        <div class="section-title text-lg-start text-center mb-4 pb-xl-3">
                            ...
                            <p class="pra fs-seven">
                                Software, web, mobile &amp; medical systems with Section 508 / WCAG and HIPAA-aligned security for enterprise and healthcare delivery.
                            </p>
                        </div>
                        <div class="row g-4 justify-content-center justify-content-lg-start text-lg-start text-center">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="business-items">
                                    ...
                                    <p class="pra fs-seven">
                                        Cloud, SEO &amp; marketing — secure hosting, growth &amp; visibility
                                    </p>
                                </div>
                            </div>
                        </div>
