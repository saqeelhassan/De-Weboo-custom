...
dw_load_page_seo('cloud-services'); // New SEO slug
        ...
        <div class="container">
            <div class="bread-content text-center">
                <ul class="d-flex align-items-center gap-3 justify-content-center">
                    ...
                    <li class="p3-clr">/</li>
                    <li class="white">Cloud Services</li>
                </ul>
                <h1 class="white visible-from-right">Cloud Services</h1>
            </div>
        </div>
        <!-- bread Element -->
                ...
                <div class="col-lg-8">
                    <div class="service-details-content">
                        <div class="thumb rounded-3 mb-xl-5 mb-4 wow fadeInUp" data-wow-delay=".4s">
                            <img loading="lazy" src="/assets/img/services/service-cloud.svg" alt="Cloud Services — Secure Architecture &amp; HIPAA Hosting" class="w-100 rounded-3">
                        </div>
                                ...
                                <li class="d-flex gap-2">
                                    ...
                                    <div class="fw-semibold black">
                                        ...
                                        <p class="fs-seven fw_400 pra">
                                            Tailored cloud solutions designed for your specific business needs and scalability.
                                        </p>
                                    </div>
                                </li>
                                <li class="d-flex gap-2">
                                    ...
                                    <div class="fw-semibold black">
                                        ...
                                        <p class="fs-seven fw_400 pra">
                                            Expert guidance and execution for migrating your applications and data to the cloud.
                                        </p>
                                    </div>
                                </li>
                                <li class="d-flex gap-2">
                                    ...
                                    <div class="fw-semibold black">
                                        ...
                                        <p class="fs-seven fw_400 pra">
                                            Specialized hosting environments meeting strict healthcare data security standards.
                                        </p>
                                    </div>
                                </li>
                            </ul>
                                        ...
                                        <div id="collapseOne001" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                <p class="fs-seven pra">
                                                    We work with major cloud providers like AWS, Azure, and Google Cloud Platform, as well as hybrid cloud solutions, to meet your specific needs.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-item">
                                    <div class="accordion-header" id="headingTwo001">
                                        ...
                                        <div id="collapseTwo001" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p class="fs-seven pra">
                                                    We implement multi-layered security protocols, including encryption, access management, network security, and continuous monitoring, to protect your cloud environment.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-item">
                                    <div class="accordion-header" id="headingThree001">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            What is HIPAA-friendly hosting?
                                        </button>
                                        <div id="collapseThree001" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p class="fs-seven pra">
                                                    HIPAA-friendly hosting refers to cloud environments configured with the necessary technical and administrative safeguards to help healthcare organizations comply with HIPAA regulations for protected health information (PHI).
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-item">
                                    <div class="accordion-header" id="headingfour001">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            Can you help optimize our current cloud spending?
                                        </button>
                                        <div id="collapsefour001" class="accordion-collapse collapse"
                                            aria-labelledby="headingfour001" data-bs-parent="#accordionExample1">
                                            <div class="accordion-body">
                                                <p class="fs-seven pra">
                                                    Yes, we offer cloud cost optimization services, analyzing your current usage and recommending strategies to reduce expenses without compromising performance or security.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
